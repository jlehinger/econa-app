...
export const LABS = [
  ...
  },
  {
    ...
    assessment: {
      instrumentName: 'Kessler Psychological Distress Scale (K6)',
      description: 'A validated 6-item measure of psychological distress — how often in the past 30 days you felt nervous, hopeless, restless, depressed, everything was an effort, or worthless. Supplemented by the Buss-Perry Aggression Questionnaire Short Form (BPAQ-SF, 12 items) to capture anger-hostility, a distinct but related dimension for founders.',
      scoring: 'K6: Each item scored 0 (None of the time) to 4 (All of the time). Total 0–24 — low scores indicate low distress, high scores indicate high distress. BPAQ-SF: Each item rated 1 (very unlike me) to 5 (very like me). Sum all 12 items.',
      citation: 'K6: Kessler, R.C. et al. (2002). Short screening scales to monitor population prevalences and trends in non-specific psychological distress. Psychological Medicine. BPAQ-SF: Bryant, F.B., & Smith, B.D. (2001). Journal of Research in Personality, 35(2), 138–167.',
      trackingNote: 'Retake every 4–6 weeks. Both instruments together give a fuller picture of emotional regulation challenges.',
    },
    action: {
